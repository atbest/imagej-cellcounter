...
public class CellCntrImageCanvas extends ImageCanvas{
    ...
    public void mousePressed(MouseEvent e) {
        ...
        if (!delmode){
            ...
            if ( !currentMarkerVector.hasMarker(m) ) {
        ...
        while(it.hasNext()){
            ...
            while(mit.hasNext()){
                ...
                if (sameSlice || showAll){
                    ...
                    else if ( Math.abs(m.getZ()-img.getCurrentSlice()) <= stackNum * img.getNChannels() )
                    	g2.drawOval((int)xM-2, (int)yM-2,4,4);
                    if (showNumbers && Math.abs(m.getZ()-img.getCurrentSlice()) <= stackNum * img.getNChannels() )
    ...
    public void setMarkerType(int num) {
        this.markerType = num;
    }
